...
public class ADMIN_CONSULTAR extends javax.swing.JFrame {
    private static final long serialVersionUID = 7526472295L;
    ...
    public void obtenerFilas(){
        modelo =conAcc.obtenerAdministradores(info.getConexion());
    ...
    private void initComponents() {
        ...
        jLabel16.setText("ADMINISTRADORES");
    ...
    private void IMPRIMIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IMPRIMIRActionPerformed
        ...
        if(fila!=-1){
            ADMIN_IMP ventana= new ADMIN_IMP();
            ventana.setInfo(info);
    ...
    private void CAJATEXTO_BUSCARKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CAJATEXTO_BUSCARKeyReleased
        if(!CAJATEXTO_BUSCAR.getText().equals("") || CAJATEXTO_BUSCAR.getText()!=null){
            modelo = conAcc.buscaAdmin(info.getConexion(), CAJATEXTO_BUSCAR.getText());
            TABLA.setModel(modelo);
        }
    ...
    private void ELIMINARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ELIMINARActionPerformed
        ...
        if(fila>=0){
            ...
            idAdm = Integer.parseInt(TABLA.getValueAt(fila, 0).toString());
            if(idAdm==info.getIdAdm()){
                Tools.Mostrar("No te puedes eliminar de los registros");
                
            }else{
                nombre = modelo.getValueAt(fila, 1).toString();
                if(Tools.JOPYN("Desea Eliminar al Administrador "+nombre, "Eliminar Administrador")==JOptionPane.YES_OPTION){
                if(conAcc.eliminarAdmin(info.getConexion(), idAdm)){
    ...
    private void EDITARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EDITARActionPerformed
        ...
        if(fila >=0){
            ADMIN_EDITAR ventana= new ADMIN_EDITAR();
            ventana.setInfo(info);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADMIN_CONSULTAR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADMIN_CONSULTAR().setVisible(true);
            }
        });
    }
