 ...
 * @author amigo
 */
public class CLIENTE_IMP extends javax.swing.JFrame implements Printable{
    private static final long serialVersionUID = 524722562276147L;
ControlAcceso conAcc = new ControlAcceso();
    ...
    void LlenaHoja(int fila){
        ...
        ETIQUETA_CLI.setText(modelo.getValueAt(fila, 0).toString());
        ETIQUETA_NOMBRE.setText(modelo.getValueAt(fila, 1).toString());
        ETIQUETA_APPATERNO.setText(modelo.getValueAt(fila, 2).toString());
        ETIQUETA_APMATERNO.setText(modelo.getValueAt(fila, 3).toString());
        ETIQUETA_TELEFONO.setText(modelo.getValueAt(fila, 4).toString());
        ETIQUETA_CORREO.setText(modelo.getValueAt(fila, 5).toString());
        ETIQUETA_CALLE.setText(modelo.getValueAt(fila, 6).toString());
        ETIQUETA_NUMERO.setText(modelo.getValueAt(fila, 7).toString());
        ETIQUETA_COLONIA.setText(modelo.getValueAt(fila, 8).toString());
        ETIQUETA_CIUDAD.setText(modelo.getValueAt(fila, 9).toString());
        ETIQUETA_ESTADO.setText(modelo.getValueAt(fila, 10).toString());
        ETIQUETA_OBSERVACIONES.setText(modelo.getValueAt(fila, 11).toString());
        ETIQUETA_COMERCIO.setText(modelo.getValueAt(fila, 12).toString());
    ...
    private void initComponents() {
        ...
        ETIQUETA_CLI = new javax.swing.JLabel();
        ...
        ETIQUETA_CLI.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ETIQUETA_CLI.setText(" ");
        ...
        ETIQUETA_OBSERVACIONES.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ETIQUETA_OBSERVACIONES.setText(" ");
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                        .addComponent(ETIQUETA_TELEFONO, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
                                        .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(ETIQUETA_CORREO, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(16, 16, 16))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addGap(25, 25, 25))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(ETIQUETA_CLI, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ETIQUETA_COMERCIO, javax.swing.GroupLayout.PREFERRED_SIZE, 430, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(ETIQUETA_OBSERVACIONES, javax.swing.GroupLayout.PREFERRED_SIZE, 484, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18))))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ETIQUETA_OBSERVACIONES, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CLIENTE_IMP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CLIENTE_IMP().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel ETIQUETA_CLI;
