...
public class ADMIN_AGREGAR extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CAJATEXTO_CLAVE = new javax.swing.JPasswordField();
        ...
        jLabel15.setText("AGREGAR ADMINISTRADOR");
        ...
        CAJATEXTO_CLAVE.setToolTipText("");
        CAJATEXTO_CLAVE.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                CAJATEXTO_CLAVEFocusGained(evt);
            }
        });

        CAJATEXTO_CLAVE2.setToolTipText("ingresa la misma contraseña que la anterior");
        CAJATEXTO_CLAVE2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                CAJATEXTO_CLAVE2FocusGained(evt);
            }
        });
        CAJATEXTO_CLAVE2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                CAJATEXTO_CLAVE2ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(CAJATEXTO_CIUDAD, javax.swing.GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
                            .addComponent(CAJATEXTO_CLAVE))
                        .addGap(44, 44, 44)
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabel14)
                            .addComponent(jLabel17)
                            .addComponent(CAJATEXTO_CLAVE2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 264, Short.MAX_VALUE)
                            .addComponent(CAJAOPCIONES_ESTADO, javax.swing.GroupLayout.Alignment.TRAILING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addGap(20, 20, 20)
        ...
        jPanel8Layout.setVerticalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGap(16, 16, 16)
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(CAJATEXTO_CLAVE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void BOTON_GUARDARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BOTON_GUARDARActionPerformed
        String clave1=String.valueOf(CAJATEXTO_CLAVE.getPassword());
        ...
        if(nombre.equals("")){
            ...
            if(conDat.validaPassword(clave1, clave2)){
                if(verifica()){
                    usuario=crearUsuario(CAJATEXTO_NOMBRE.getText());
                    ...
                    clave = String.valueOf(CAJATEXTO_CLAVE2.getPassword());
                    conAcc.agregarAdmin(info.getConexion(), usuario, nombre, apellidoPaterno, apellidoMaterno,
                            telefono, correo, calle, numero, colonia, ciudad, estado, clave);

                    JOptionPane.showMessageDialog(null, "INFORMACIÓN GUARDADA", "GUARDADO", 
                            JOptionPane.INFORMATION_MESSAGE, null );
                    LimpiarCampos();
                }
            }else
                JOptionPane.showMessageDialog(null, "Las contraseñas no coinciden o no son correctas","Advertencia",JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void CAJATEXTO_CLAVE2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CAJATEXTO_CLAVE2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_CAJATEXTO_CLAVE2ActionPerformed
    ...
    private void CAJATEXTO_CLAVEFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_CAJATEXTO_CLAVEFocusGained
        CAJATEXTO_CLAVE.selectAll();
    }//GEN-LAST:event_CAJATEXTO_CLAVEFocusGained
    ...
    public String crearUsuario(String nombre){
        ...
        String nomAux = nombre = nombre.toLowerCase().replace(' ', '\u0000');
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ADMIN_AGREGAR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ADMIN_AGREGAR().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPasswordField CAJATEXTO_CLAVE;
