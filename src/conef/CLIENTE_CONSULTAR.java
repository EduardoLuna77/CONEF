...
public class CLIENTE_CONSULTAR extends javax.swing.JFrame {
    private static final long serialVersionUID = 752647295677L;
    ...
    public void obtenerFilas(){
        modelo = conAcc.obtenerClientes(info.getConexion());
    ...
    private void initComponents() {
        ...
        jScrollPane1.setBackground(new java.awt.Color(202, 248, 202));
    ...
    private void IMPRIMIRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_IMPRIMIRActionPerformed
        ...
        if(fila!=-1){
            CLIENTE_IMP ventana= new CLIENTE_IMP();
            ventana.setInfo(info);
    ...
    private void CAJATEXTO_BUSCARKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_CAJATEXTO_BUSCARKeyReleased
        if(!CAJATEXTO_BUSCAR.getText().equals("") || CAJATEXTO_BUSCAR.getText()!=null){
            modelo = conAcc.buscaCliente(info.getConexion(), CAJATEXTO_BUSCAR.getText());
            TABLA.setModel(modelo);
        }
    ...
    private void ELIMINARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ELIMINARActionPerformed
        ...
        if(fila>=0){
            ...
            idCli = Integer.parseInt(TABLA.getValueAt(fila, 0).toString());
            
                nombre = modelo.getValueAt(fila, 1).toString();
                if(Tools.JOPYN("¿Seguro que desea eliminar al cliente "+nombre+"?", "Eliminar Cliente")==JOptionPane.YES_OPTION){
                if(conAcc.eliminarCliente(info.getConexion(), idCli)){
    ...
    private void EDITARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EDITARActionPerformed
        ...
        if(fila >=0){
            CLIENTE_EDITAR ventana= new CLIENTE_EDITAR();
            ventana.setInfo(info);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CLIENTE_CONSULTAR.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CLIENTE_CONSULTAR().setVisible(true);
            }
        });
    }
